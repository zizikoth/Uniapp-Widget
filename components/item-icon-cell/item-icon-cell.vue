<template>
	<view class="iic-box" :class="{'iic-box-line':line}" @click="click()">
		<image class="iic-icon" :src="icon" :style="{
			'margin-left':margin+'rpx'
		}" />

		<text class="iic-title">{{title}}</text>

		<text class="iic-subtitle">{{subTitle}}</text>

		<uni-badge type="error" size="small" :text="dot?1:badge" :isDot="dot" />

		<view class="right-arrow-black" :style="{
